...

{
    ...
    if ((ControlArea->u.Flags.GlobalOnlyPerSession == 0) &&                                     // 获取subsection 域
    ...
    Status = MiCheckPurgeAndUpMapCount (ControlArea, TRUE);                                     // 检查purge操作是否完成，若没有则等待。同时增加ControlArea中map view 的引用次数
