...
POBJECT_TYPE ObpTypeObjectType;                                     // 类型对象类型
POBJECT_TYPE ObpDirectoryObjectType;                                // 目录对象类型
POBJECT_TYPE ObpSymbolicLinkObjectType;                             // 符号链接对象类型
POBJECT_TYPE ObpDeviceMapObjectType;                                // 设备Map对象类型
POBJECT_DIRECTORY ObpRootDirectoryObject;                           // 对象根目录
POBJECT_DIRECTORY ObpTypeDirectoryObject;                           // 对象类型目录
